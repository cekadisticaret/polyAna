...
CURATED = [
    ...
    {"title": "Mudanya Mütareke Evi", "ilce": "Mudanya", "address": "Mudanya iskele, Mudanya", "lat": 40.3764, "lng": 28.8832, "sub": "muze", "rating": 4.5, "featured": True, "blurb": "1922 ateşkes evi. Sahil yürüyüşüyle birlikte."},
    ...
    try:
        ...
        for i, raw in enumerate(CURATED):
            ...
            st = upsert(
                ...
                img=SUB_IMG.get(raw["sub"]) or SUB_IMG["anit"],
