...
| `temmuzPoly/` | Polymarket trader sistemleri. `poly_trader_analiz3.py` (Stoch RSI/ETH sanal $300), `analiz1/2/4/5/9/10/12`, `karisim1`, `eth_analiz` ve sinyal motoru `poly_predictor_analysis.py`. |
