...
| `temmuzPoly/vote_paper.py` | İlk 10 rejim oyu (TOP1–4 hariç) — grup çoğunluğuna **$48** sanal Poly dolum; TOP1 Durgun / TOP2 Trend / TOP3 Canlı / **TOP4 Sembol** (coin başına en iyi :05) · `vote_paper.json` · gerçek emir yok |
...
| `GET /poly/api/mirror` | 69 defter + **TOP1–4** (hepsi net P&L çoktan aza, `vote_paper: true`) |
