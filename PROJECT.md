...
| `Analiz31/predictor.py` | HTF bias + kill zone + dinamik gate tahmin motoru (**v1.1 yama**) |
...
| `temmuzPoly/backtest_analiz31.py` | 31. Analiz 1Y Multi-TF backtest (BTC+SOL, v1.1 motor) |
| `temmuzPoly/poly_trader_analiz4.py` | 4. Analiz sanal (BTC+ETH); PM gamma fiyatından gerçekçi P&L |
| `temmuzPoly/poly_trader_analiz5.py` | 5. Analiz A1 motoru BTC+SOL **gerçek PM** ($6–12/işlem WR'ye göre) |
| `temmuzPoly/poly_trader_analiz7.py` | 7. Analiz Enhanced 6-algo BTC 1H sanal ($500, $15) |
...
| `temmuzPoly/btc_analiz21_algo.py` | 21. Analiz motoru — BTC Hull MA / ETH Volume Profile / SOL MACD Hist |
...
| `temmuzPoly/poly_trader_5m_btc_105.py` | 5M 105 BTC sanal ($200, $8-12/işlem WR'ye göre) |
...
- `temmuzPoly/poly_trader_analiz2.py close/open` — saat başı / **5 geçe**: 2. Analiz **SOL only** sanal ($300, $10-15-20); **24/7**
...
# KALDIRILDI: `temmuzPoly/poly_trader_analiz3.py`, `poly_trader_analiz6.py`, `btc_analiz_hourly.py`
