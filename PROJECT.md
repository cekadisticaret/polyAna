...
| `web/poly_dashboard.py` | Poly dashboard — harita/geçmiş, PM kotasyon; **A1 Live / A2 / 210** aç-kapat; **`/poly/islemler`** manuel 15dk/saatlik PM; port **5050**. |
...
| `temmuzPoly/pm_poly_history.py` | Polymarket data-api activity → slug bazlı gerçek PM geçmişi |
...
| `temmuzPoly/pm_weekend_sync.py` | Cum 22:00 / Paz 18:00 İST — 3 PM anahtarını otomatik kapat/aç (dashboard senkron) |
...
- `temmuzPoly/pm_weekend_sync.py close/open` — Cum **22:00** / Paz **18:00** İST: A1 Live + A2 + 210 dashboard anahtarları (manuel override mümkün)
