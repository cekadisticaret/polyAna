...
| `temmuzPoly/` | Polymarket trader sistemleri. Aktif coinler: BTC, ETH, SOL (XRP/DOGE/BNB/HYPE pasif). `analiz5` (1h gerçek PM, BTC+SOL, dinamik $6/$8/$10), `analiz10` (1h gerçek PM, BTC+SOL, çift konsensüs sabit $10), `analiz9` (sanal $300, BTC+ETH+SOL), `analiz2`/`analiz12`/`analiz13` silindi, `karisim1` (A1+A4), `5M 101-104` sanal, `5M 201/202` pasif. PM min bakiye: $120. |
