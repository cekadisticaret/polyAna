...
| `temmuzPoly/` | Poly trader'lar, 5M 102/103; dashboard port **5050**. |
...
| `temmuzPoly/pm_trader_helpers.py` | PM emir + 1h/5m sanal kotasyon (`pm_sanal_quote`, `pm_5m_sanal_quote`) |
...
| `temmuzPoly/poly_trader_analiz10.py` | 10. Analiz çift konsensüs sanal (BTC+SOL, $300, $10/işlem, PM kotasyon P&L) |
...
| `temmuzPoly/btc_analiz_hourly.py` | BTC ANALİZ — 27 oy özeti (:01, zayıf 15 algo+A4/A9 hariç) + Analiz 509 |
...
- `temmuzPoly/poly_trader_analiz10.py close/open` — saat başı / 6 geçe: çift konsensüs BTC+SOL **sanal** ($300, $10/işlem, PM kotasyon P&L)
