...
Sabit $36–64/işlem (WR'ye göre), BTC+SOL.

Hafta sonu duraklama: Cuma 22:00 – Pazartesi 11:00 İST (open atlanır; close açık pozisyon varsa çalışır).
...
# ── Config ────────────────────────────────────────────────────
BOT_TOKEN = "8635088185:AAE1sbJgDWAM55COI9-AnBqsx2AY47rsJaM"
CHAT_ID   = "802982787"
...
TRADE_AMOUNT       = 36.0  # genel WR veri yok veya tam %50
TRADE_AMOUNT_HIGH  = 64.0  # sembol genel WR > %50
TRADE_AMOUNT_LOW   = 48.0  # sembol genel WR < %50
MIN_STAT_COUNT  = 10


def _in_weekend_pause(now_tr: datetime) -> bool:
    """Cuma 22:00 – Pazartesi 11:00 İST arası yeni işlem açılmaz."""
...
async def run_open() -> None:
    ...
    if _in_weekend_pause(now_tr):
        print(f"[5. ANALİZ open] {saat} İST — hafta sonu duraklama (Cum 22:00 – Pzt 11:00), işlem yok")
        return
