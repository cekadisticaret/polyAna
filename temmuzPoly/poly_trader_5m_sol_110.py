...
STATE_FILE = os.path.join(_DIR, "poly_trader_5m_sol_110_state.json")
HISTORY_FILE = os.path.join(_DIR, "poly_trader_5m_sol_110_history.json")
WEEKLY_IMG = "/tmp/poly_15m_sol_110_weekly.png"
...
_PM_LIVE = os.getenv("PM_5M_110_REAL_ENABLED", "false").lower() in ("1", "true", "yes")
