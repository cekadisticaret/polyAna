"""
B1#02 — Sabit sembol motorları: BTC→A15 · ETH→A6 · SOL→A2#01
...
from b1_02_signal import SYMBOLS, resolve_live_signal, engine_label, load_mapping
...
STATE_FILE    = os.path.join(_DIR, "poly_trader_b1_02_state.json")
HISTORY_FILE  = os.path.join(_DIR, "poly_trader_b1_02_history.json")
WEEKLY_IMG    = "/tmp/poly_b1_02_weekly_heatmap.png"
LABEL         = "B1#02"
BOOK_KEY      = "b1_02"
ALGO_NAME     = "BTC→A15 · ETH→A6 · SOL→A2#01"
