"""6. ANALİZ LIVE — analiz6 sinyali gerçek PM (BTC+SOL+ETH). Dashboard kapalı başlar."""
...
from poly_trader_analiz6 import (
    SYMBOLS,
    _resolve_signal,
    get_stats,
    get_symbol_stats,
...
STATE_FILE = os.path.join(_DIR, "poly_trader_analiz6_live_state.json")
HISTORY_FILE = os.path.join(_DIR, "poly_trader_analiz6_live_history.json")
HATA_FILE = os.path.join(_DIR, "analiz6_live_polyhata.json")
LABEL = "6. ANALİZ LIVE"
TRADE_AMOUNT = 10.0
TRADE_AMOUNT_LOW = 8.0
TRADE_AMOUNT_HIGH = 12.0
_PM_LIVE = os.getenv("PM_ANALIZ6_LIVE_ENABLED", "false").lower() in ("1", "true", "yes")
