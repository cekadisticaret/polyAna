"""
6. ANALİZ V3 — BTC+ETH A6 motorları, SOL A2 predictor

BTC → A6 MACD Hist. Div · ETH → A6 RSI Div · SOL → A2 predictor
...
from analiz6_v3_signal import SYMBOLS, resolve_live_signal, engine_label
from pm_trader_helpers import (
    apply_pm_quote, resolve_slot_trade_amount, slot_amount_log,
    pm_sanal_settle_trade, pm_sanal_slot_candle,
    symbol_wr_amount_for_book, pm_hourly_profit_entry_ok, pm_tg_stake,
...
STATE_FILE    = os.path.join(_DIR, "poly_trader_analiz6_v3_state.json")
HISTORY_FILE  = os.path.join(_DIR, "poly_trader_analiz6_v3_history.json")
WEEKLY_IMG    = "/tmp/poly_analiz6_v3_weekly_heatmap.png"
LABEL         = "6. ANALİZ V3"
BOOK_KEY      = "analiz6_v3"
ALGO_NAME     = "BTC/ETH→A6 · SOL→A2"
