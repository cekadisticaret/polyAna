"""REF03 sanal defter. Gerçek PM yok.

REF01 mantığı (trend + fade) — yalnız ask ≤ 0.55 girişleri kabul eder.
...
from ref03_signal import ASK_MAX, SYMBOLS, decide  # noqa: E402
...
STATE_FILE = os.path.join(_DIR, "poly_trader_ref03_state.json")
HISTORY_FILE = os.path.join(_DIR, "poly_trader_ref03_history.json")
LABEL = "REF03"
BOOK_KEY = "ref03"
ALGO_NAME = "REF03 · ask≤0.55"
INITIAL_BALANCE = 1000.0
REF03_MIN_PROFIT_RATIO = 0.25  # REF01 ile aynı kâr kapısı
...
def run_open() -> None:
    ...
    opened, skipped = [], []
    verbose = os.environ.get("REF03_TICK_VERBOSE") == "1"
    ...
    for sym in SYMBOLS:
        ...
        pos = {
            ...
            "algo_name": ALGO_NAME,
            "ref03_mode": dec.get("mode"),
            "ref03_detail": dec.get("detail"),
            "ref03_path_bps": dec.get("path_bps"),
            "ref03_first_side": dec.get("first_side"),
            "ref03_cross_min": dec.get("cross_min"),
            "ref03_entry_min": now_tr.minute,
        }
        apply_pm_quote(
            pos, sym, dec["direction"], stake, now,
            min_profit_ratio=REF03_MIN_PROFIT_RATIO,
        )
...
def run_close() -> None:
    ...
    for pos in list(state["open_positions"]):
        ...
        rec = {
            ...
            "ref03_mode": pos.get("ref03_mode"),
            "ref03_detail": pos.get("ref03_detail"),
            "ref03_path_bps": pos.get("ref03_path_bps"),
            "ref03_first_side": pos.get("ref03_first_side"),
            "ref03_cross_min": pos.get("ref03_cross_min"),
            "ref03_entry_min": pos.get("ref03_entry_min"),
        }
