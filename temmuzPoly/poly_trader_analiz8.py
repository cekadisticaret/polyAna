...
def run_open() -> None:
    ...
    tg_send(
        f"{sep}\n"
        f"🔬 <b>8. ANALİZ — {saat} İST</b>  ({day_lbl})\n"
...
def run_weekly() -> None:
    ...
    pnl_icon  = "🟢" if total_pnl >= 0 else "🔴"
    tg_send(
        f"📊 <b>8. ANALİZ HAFTALIK İSTATİSTİKLER</b>\n"
