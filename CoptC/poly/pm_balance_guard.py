...
# CoptC: hiçbir grup varsayılan açık değil. Ana projede analiz5/analiz2/analiz10
# açık geliyordu; kontrol dosyası yeni sunucuda yoksa A1 Live kendiliğinden
# gerçek para açardı. Açma yalnız dashboard üzerinden.
_DEFAULT_OPEN_GROUPS = frozenset()
...
def _load_control() -> dict:
    defaults = {
        "analiz5_paused": True,
        "analiz2_paused": True,
        "analiz10_paused": True,
        "analiz6_live_paused": True,
        "15m_309_live_paused": True,
