"""
B1#03 MUM ANALİZ — Sonnet mum pattern + destek/direnç confluence (saatlik)
...
from b1_mum_signal import SYMBOLS, resolve_live_signal, engine_label
...
STATE_FILE    = os.path.join(_DIR, "poly_trader_b1_mum_state.json")
HISTORY_FILE  = os.path.join(_DIR, "poly_trader_b1_mum_history.json")
WEEKLY_IMG    = "/tmp/coptc_poly_b1_mum_weekly_heatmap.png"
LABEL         = "B1#03 MUM ANALİZ"
BOOK_KEY      = "b1_mum"
