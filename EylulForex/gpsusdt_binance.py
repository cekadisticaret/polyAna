"""GPSUSDT — Binance USDT-M (fapi) piyasa katmanı. Emir atmaz.

Canlı `crypto_futures_trader` ile aynı filtre / taker / dolum aritmetiği.
"""
...
from fee_utils import DEFAULT_TAKER_FEE, get_taker_rate  # noqa: E402
